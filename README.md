...
### My Core Tech Stack
- **Deep Learning libraires**: Jax (with flax nnx and pallas), (**new**) CuTile (for custom kernels), PyTorch, Transformers, Unsloth (for fast PEFT on local hardware)
...
[GitHub](https://github.com/DenisSud/) | sudakov.denis.2007@gmail.com | t.me/DenisSud2
